...
public class PostMonsoon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemDescImage.setImageResource(R.drawable.post_monsoon);
