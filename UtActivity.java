...
public class UtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<Word> utArrayList = new ArrayList<Word>();

        utArrayList.add(new Word(getString(R.string.adaman), R.drawable.ic_an, R.raw.andaman));
        utArrayList.add(new Word(getString(R.string.chandigarh), R.drawable.ic_ch, R.raw.chandighar));
        utArrayList.add(new Word(getString(R.string.dadar), R.drawable.ic_dn, R.raw.dadra));
        utArrayList.add(new Word(getString(R.string.daman), R.drawable.ic_dd, R.raw.daman));
        utArrayList.add(new Word(getString(R.string.delhi), R.drawable.ic_dl, R.raw.delhi));
        utArrayList.add(new Word(getString(R.string.lakshadeep), R.drawable.ic_ld, R.raw.laksha));
        utArrayList.add(new Word(getString(R.string.pondicherry), R.drawable.ic_pd, R.raw.pondicherry));




        WordArrayAdapter itemsAdapter =
                new WordArrayAdapter(this, utArrayList, R.color.color_geography);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Word word = utArrayList.get(position);
                ...
                if(audioFocusStatus == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mediaPlayer = MediaPlayer.create(UtActivity.this, word.getmAudioResourceID());
