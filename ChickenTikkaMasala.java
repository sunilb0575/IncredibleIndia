...
public class ChickenTikkaMasala extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemDescImage.setImageResource(R.drawable.chicken_tikka_masala);
