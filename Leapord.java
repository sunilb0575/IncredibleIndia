...
public class Leapord extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemDescImage.setImageResource(R.drawable.leopard);
